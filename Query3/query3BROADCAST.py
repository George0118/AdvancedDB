...
spark = SparkSession.builder.appName("Query 3 BROADCAST HINT").getOrCreate()
...
# First Join
first_join = crimes_df1_2015.join(reverse_geocoding_data.hint("BROADCAST"), ["LAT", "LON"], "inner")
first_join.explain()
...
# Second Join
merged_data = first_join.join(combined_incomes.hint("BROADCAST"), first_join["ZIPcode"] == combined_incomes["Zip Code"], "inner")
