...
spark = SparkSession.builder.appName("Query 3 MERGE HINT").getOrCreate()
...
# First Join
first_join = crimes_df1_2015.join(reverse_geocoding_data.hint("MERGE"), ["LAT", "LON"], "inner")
...
# Second Join
merged_data = first_join.join(combined_incomes.hint("MERGE"), first_join["ZIPcode"] == combined_incomes["Zip Code"], "inner")
