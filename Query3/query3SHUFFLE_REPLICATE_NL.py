...
spark = SparkSession.builder.appName("Query 3 SHUFFLE_REPLICATE_NL HINT").getOrCreate()
...
# Second Join
merged_data = first_join.join(combined_incomes.hint("SHUFFLE_REPLICATE_NL"), first_join["ZIPcode"] == combined_incomes["Zip Code"], "inner")
